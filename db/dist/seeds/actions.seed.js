...
export async function seedActions() {
    const actionsList = [
        ...
        },
        {
            ...
            editable: false,
            required: false,
            description: "Filter orders by [key] > || < || = [value], e.g.: price > 10",
            config: {
                price: true,
                minPrice: 10,
            },
        },
        {
            ...
            editable: false,
            required: false,
            description: "Normalize [key]: [value] => [key]: [normalizedValue], e.g.: phoneNumber: '0599876543' => normalize => phoneNumber: '+970599876543'",
        ...
        },
        {
            ...
            editable: true,
            required: false,
            description: "Retry to calculate [key]: [value] to be ensure that calculated correctly, e.g.: totalPrice = sum(items.price)",
