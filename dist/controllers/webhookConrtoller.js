import { getSourceByURL } from "../db/queries/sources.js";
import { BadRequestError, ForbiddenError, NotFoundError, } from "../lib/classes/errors.js";
import { getPipelineBySourceID } from "../db/queries/pipelines.js";
...
export const webhookIngestionHandler = async (req, res, next) => {
    try {
        ...
        if (event !== "order-complete") {
            throw new ForbiddenError("This operation is not allowed, the order is not completed");
        }
